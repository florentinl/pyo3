...
use crate::{
    ...
    ffi, Borrowed, PyAny, PyResult, Python,
};
...
impl PyContext {
    /// Registers a context watcher.
    ///
    /// Use `watch_callback!` to create a callback function which can be passed to this method.
    pub fn add_watcher(
        py: Python<'_>,
...
///
/// The only way to create this is through the `watch_callback!` macro.
#[repr(transparent)]
...
/// Implementation details used by [`watch_callback!`](crate::watch_callback).
#[doc(hidden)]
pub mod impl_ {
